...
#vivian 
younger_list = PythonOperator(
    task_id = "younger_list_task",
    dag=dag,
    python_callable= fn_younger_rider 
)

create_younger_table = PostgresOperator(
    task_id = "create_young_task",
    dag = dag,
    sql ="""
        BEGIN;
...
create_younger_table >> younger_list
